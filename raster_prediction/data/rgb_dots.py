...
class RgbDots(Dataset):
    ...
    def draw_circles(self, idx, x, y):
        ...
        r = 4
        circle = circles[0]
        draw_x.ellipse((circle[0] - r, circle[1] - r, circle[0] + r, circle[1] + r), fill="red")
        circle = circles[1]
        draw_x.ellipse((circle[0] - r, circle[1] - r, circle[0] + r, circle[1] + r), fill="green")
        circle = circles[2]
...
if __name__ == '__main__':
    ...
    motion_dataset = RgbDots(1000, (64, 64))
    data_loader = DataLoader(motion_dataset, batch_size=30, shuffle=True)
